...
기획서(고성모_기획서.docx) 주차 계획·9장 체크리스트와 연동. **기획서 2.2/3.1/5.1은
...
## ✅ 완료 (2026-07-10 — 전면 리팩토링, feat/think)

- [x] 타깃 변경: Jetson → **윈도우 + NVIDIA + Python 3.11.5** (정부 민원발급기)
...
- Jetson Orin Nano는 타깃에서 제외 — docs/JETSON_SETUP.md는 기록 보관용 (2026-07-10)
